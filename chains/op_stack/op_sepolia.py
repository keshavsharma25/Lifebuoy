...
from utils.config import LocalAcc
...
class OP_Sepolia:
    def __init__(self) -> None:
        ...
        self.SEPOLIA_OP_PORTAL_PROXY = "0x16FC5058F25648194471939DF75CF27A2FDC48BC"
    ...
    def get_l1_contract(self):
        return self.l1p.eth.contract(
            address=Web3.to_checksum_address(self.SEPOLIA_OP_PORTAL_PROXY),
            abi=self.get_abi(),
        )
        ...
        txn_payload: TxParams = txn.build_transaction(
            {
                ...
                "value": Wei(value),
                "gas": estimated_gas,
                "nonce": self.l1p.eth.get_transaction_count(to),
